package br.com.delfino.security.jwt;
...
import br.com.delfino.data.vo.v1.security.TokenVO;
import br.com.delfino.exceptions.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
	...
	public TokenVO createAcessToken(String username, List<String> roles) {
		...
		//return new TokenVO(username, true, instant, validity, accessToken, refreshToken);
	}
