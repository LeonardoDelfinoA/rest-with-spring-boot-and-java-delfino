package br.com.delfino.integrationtests.controller.withxml;
...
import br.com.delfino.integrationtests.vo.PersonVO;
...
public class PersonControllerCorsXmlTest extends AbstractIntegrationTest {
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("Sergio", foundPersonOne.getFirstName());
		assertEquals("Mallandro", foundPersonOne.getLastName());
		assertEquals("Rio de Janeiro - Brasil", foundPersonOne.getAddress());
		...
		assertEquals("Nikola", foundPersonFour.getFirstName());
		assertEquals("Tesla", foundPersonFour.getLastName());
		assertEquals("Putaquepariu", foundPersonFour.getAddress());
